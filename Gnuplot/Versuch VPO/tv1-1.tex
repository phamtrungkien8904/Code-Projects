...
\begin{picture}(7200.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%%
      \put(5816,4206){\makebox(0,0)[r]{\strut{}$\hat{U}_R$}}%
      \csname LTb\endcsname%%
      \put(5816,3986){\makebox(0,0)[r]{\strut{}$\hat{U}_C$}}%
      \csname LTb\endcsname%%
      \put(209,2541){\rotatebox{-270.00}{\makebox(0,0){\strut{}Spannung $U$ (V)}}}%
      \put(3874,154){\makebox(0,0){\strut{}Frequenz $f$ (kHz)}}%
      \put(3874,4709){\makebox(0,0){\strut{}RC-Glied: Frequenzgang}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={360.00bp},height={252.00bp}]{tv1-1}}%
    \gplfronttext
  \end{picture}%
\endgroup
