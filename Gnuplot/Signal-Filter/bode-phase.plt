...
plot phi(x,1) title sprintf('n = %d', 1) with lines linestyle 1,\
     phi(x,2) title sprintf('n = %d', 2) with lines linestyle 2,\
     phi(x,6) title sprintf('n = %d', 6) with lines linestyle 3,\
     phi(x,10) title sprintf('n = %d', 10) with lines linestyle 5,\
