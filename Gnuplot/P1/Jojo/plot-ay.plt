...
set title "Jojo-Bewegung (t, a_y)"
set ylabel 'Beschleunigung (m/s^2)'
set xlabel 'Zeit (s)'
# set grid
set xrange [0:10]
set yrange [-50:100]
...
# Plot
plot \
    'data-60fps.csv' using 1:5 with points ls 4 notitle, \
    'data-60fps.csv' using 1:5 with lines ls 5 notitle
