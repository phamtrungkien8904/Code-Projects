...
set title 'Spannungsabfall eines Drahtes'
set ylabel 'Spannungsabfall $U$/V'
set xlabel 'Länge des Drahtes $l$/cm'
 # set grid
...
fit f(x) 'data.csv' using 1:2:(0.1):3 xyerrors via a,b 
...
# Plot
plot \
	'data.csv' using 1:2:(0.1):3 with xyerrorbars ls 2 title 'Messdaten', \
