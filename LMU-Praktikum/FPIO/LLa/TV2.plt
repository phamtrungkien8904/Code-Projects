...
set fit quiet
f(x) = a * x + b
fit f(x) 'data-TV2-papier.csv' using (cos($1/180*pi)/cos(15/180*pi)):(($2 - U0)/2.23) via a,b
...
# Plot
plot \
    'data-TV2-papier.csv' using (cos($1/180*pi)/cos(15/180*pi)):(($2 - U0)/2.23) with point ls 4 title 'Messdaten', \
